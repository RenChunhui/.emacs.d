...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-document-title ((,class (:weight bold :foreground ,rainbow-5))))
   ...
   `(org-level-1 ((,class (:inherit bold :foreground ,rainbow-4))))
   `(org-level-2 ((,class (:inherit bold :foreground ,rainbow-3))))
   `(org-level-3 ((,class (:bold nil :foreground ,rainbow-6))))
